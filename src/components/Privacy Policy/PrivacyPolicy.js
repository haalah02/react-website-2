  ...
  return (
    <div className="policy">
      <h1 className="privacy-policy-h1">
        Privacy Policy
        <br />
        <span>Last Updated On 30-Aug-2023</span>
        <br />
        <span>Effective Date 30-Aug-2023</span>
      </h1>

      <p className="privacy-policy-p">
        This Privacy Policy describes the policies of Mozilor Technologies Pvt.
        Ltd, 12345 Lane, Guhawati 765431, India, email: haalah+55@mozilor.com,
        phone: 1234567890 on the collection, use and disclosure of your
        information that we collect when you use our website (
        react-website-2.vercel.app ). (the “Service”). By accessing or using the
      ...
      <ol className="privacy-policy-ol">
        ...
        <li>
          ...
          <p className="privacy-policy-p">
            ...
            exercise these rights, you can write to us at haalah+55@mozilor.com.
        ...
        <p class="privacy-policy-p">
            ...
            <a href="https://react-website-2.vercel.app/cookie-policy">Cookie Policy.</a>
        </p>
    </li>
        <li>
        ...
        <li>
          ...
          <p className="privacy-policy-p">
            ...
            Officer at Mozilor Technologies Pvt. Ltd, 12345 Lane, email:
            haalah+55@mozilor.com. We will address your concerns in accordance
            with applicable law.
          </p>
        </li>
      </ol>
      ...
      <footer>
        <a
          ...
          href="https://react-website-2.vercel.app/home"
        >
          Back To Homepage
        </a>
      </footer>
